...
export const LEVELS: LevelDef[] = [
  ...
  },
  {
    name: "ASTEROID BELT",
    waves: [
      { groups: [{ type: "fast", count: 4 }, { type: "basic", count: 2 }], formation: "v" },
      { groups: [{ type: "tank", count: 1 }, { type: "basic", count: 4 }], formation: "line" },
  ...
  },
  {
    name: "VOID CORE",
    waves: [
      { groups: [{ type: "bomber", count: 3 }, { type: "fast", count: 3 }], formation: "circle" },
      { groups: [{ type: "sniper", count: 3 }, { type: "tank", count: 2 }], formation: "line" },
      { groups: [{ type: "basic", count: 6 }, { type: "fast", count: 4 }], formation: "spiral" },
    ],
    boss: true,
  },
];
